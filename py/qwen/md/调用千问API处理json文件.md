...
```
给我修改这个脚本：
json里面还有2个字段【Meaning】【Phonetic】，如果这2个字段为空，需要AI给我补充完整，详情如下：
Meaning是这个单词的含义，给我详细描述这个单词是什么意思，例如：adj. 不变的；恒定的；n. 常数；常量 
Phonetic是这个单词的音标，需要提供这个单词读音，例如：英 [ˈkɒnstənt]，美 [ˈkɑːnstənt]
